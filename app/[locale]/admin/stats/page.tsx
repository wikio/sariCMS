...
export default function StatsPage() {
  ...
  const content = [
    ...
    { label: 'Événements', value: counts.events || 0, color: '#169EC9' },
  ...
  return (
    <div className="space-y-4">
      <header className="flex items-end justify-between ad-rise">
        ...
        <Link href={`/${locale}/admin/logs`} className="ad-btn ad-btn-ghost">Voir les journaux</Link>
      </header>
      ...
      <div className="grid lg:grid-cols-2 gap-3">
        <section className="ad-card p-5">
          <h2 className="ad-section-title">Contenu publié</h2>
          <BarChart items={content} />
        </section>
        <section className="ad-card p-5">
          <h2 className="ad-section-title">Pipeline commandes</h2>
