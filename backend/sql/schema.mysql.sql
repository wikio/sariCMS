...
CREATE TABLE `orders` (
  ...
  `discountTotal`   DECIMAL(14, 2) NULL,
  `productDiscount` DECIMAL(14, 2) NULL,
  `globalDiscount`  DECIMAL(14, 2) NULL,
  `couponDiscount`  DECIMAL(14, 2) NULL,
  `shippingFee`     DECIMAL(14, 2) NULL,
  `productShipping` DECIMAL(14, 2) NULL,
  `globalShipping`  DECIMAL(14, 2) NULL,
  `taxTotal`        DECIMAL(14, 2) NULL,
  `taxLines`        JSON           NULL,
  `deliveryZone`    VARCHAR(80)    NULL,
  `saleZone`        VARCHAR(80)    NULL,
...
CREATE TABLE `newsletter_subscribers` (
  ...
  KEY `newsletter_subscribers_unsubscribeReason_idx` (`unsubscribeReason`),
