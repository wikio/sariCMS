...
const TOKEN_BY_COLLECTION: Record<string, symbol> = {
  ...
  [COLLECTIONS.passwordResetTokens]: PASSWORD_RESET_TOKEN_REPOSITORY,
  ...
  [COLLECTIONS.homeSections]: HOME_REPOSITORY,
  [COLLECTIONS.newsletter]: NEWSLETTER_REPOSITORY,
  [COLLECTIONS.coupons]: COUPON_REPOSITORY,
  [COLLECTIONS.taxRules]: TAX_RULE_REPOSITORY,
  [COLLECTIONS.paymentRecords]: PAYMENT_RECORD_REPOSITORY,
};
