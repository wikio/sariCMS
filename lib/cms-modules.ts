...
export const CMS_MODULES: CmsModule[] = [
  {
    ...
    fields: [
      ...
      { key: 'inStock', label: 'En stock', kind: 'toggle', group: 'Stock' },
      { key: 'stockQty', label: 'Quantité en stock', kind: 'number', hint: 'Unité de vente disponible. 0 = rupture si le stock final est activé.', group: 'Stock' },
      { key: 'stockFinal', label: 'Stock final', kind: 'toggle', hint: 'Si oui, le produit passe hors stock dès que la quantité atteint 0.', group: 'Stock' },
